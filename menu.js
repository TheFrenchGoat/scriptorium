...
async function init() {
    ...
    keys.forEach(name => {
      ...
      btnRename.addEventListener('click', (e) => {
        ...
        document.getElementById('confirmRenameProject').onclick = async () => {
          ...
          if (projects[newName]) return alert(t('alreadyExists'));
      ...
      btnDelete.addEventListener('click', (e) => {
        e.stopPropagation();
        optionsMenu.classList.remove('show');
        if (confirm(t('confirmDeleteProject', { name }))) {
          (async () => {
            delete projects[name];
            await window.api.saveProjects(projects);
  ...
  btnNew.addEventListener('click', () => {
    ...
    document.getElementById('confirmNewProject').onclick = async () => {
      ...
      if (projects[name]) return alert(t('alreadyExists'));
...
init().catch(err => {
  ...
  alert(t('menuInitErrorPrefix') + err.message + t('initErrorSuffix'));
});
