...
const dict = {
  fr: {
    // Commun
    cancel: 'Annuler', create: 'Créer', rename: 'Renommer', close: 'Fermer', launch: 'Lancer', save: 'Enregistrer',
    alreadyExists: 'Ce nom existe déjà', nameRequired: 'Le nom est obligatoire',
    renameWbMentionsWarning: 'Renommer "{oldName}" en "{newName}" remplacera aussi ce nom partout où il apparaît dans le texte de {count} chapitre(s). Continuer ?',
    ...
    settingsSectionAppearance: 'Apparence', settingsSectionCorrection: 'Correction',
    settingsSectionUpdates: 'Mises à jour',
    helpMenuBtn: '❓ Aide', helpMenuBtnTitle: 'Raccourcis clavier',
    helpModalTitle: 'Raccourcis clavier',
    shortcutSave: 'Enregistrer', shortcutUndo: 'Annuler', shortcutRedo: 'Rétablir',
    shortcutBold: 'Gras', shortcutItalic: 'Italique', shortcutUnderline: 'Souligné',
    shortcutZoom: 'Zoom de la page', shortcutWbOpen: 'Ouvrir une fiche World Building',
    shortcutAlign: 'Aligner (gauche/centre/droite)', shortcutReplace: 'Rechercher / Remplacer',
    shortcutGlobalSearch: 'Recherche globale', shortcutSwitchTab: 'Onglet suivant / précédent',
    shortcutZoomKeys: 'Zoom avant / arrière / réinitialiser',
    shortcutCloseTab: "Fermer l'onglet actif", shortcutMiddleClose: 'Fermer un onglet',
    shortcutNavigate: 'Naviguer sans souris', shortcutActivate: 'Activer un élément survolé au clavier',
    ...
    alignLeftTitle: 'Aligner à gauche', alignCenterTitle: 'Centrer', alignRightTitle: 'Aligner à droite',
    ...
    customTypeNameLabel: 'Nom du type', customTypeNamePlaceholder: 'ex : Faction, Créature, Artefact…',
    customTypeIconLabel: 'Icône', customTypeColorLabel: 'Couleur par défaut',
    customTypeFieldsLabel: 'Champs de la fiche', customTypeAddFieldBtn: '+ Ajouter un champ',
    customTypeFieldLabelPlaceholder: 'Nom du champ', customTypeFieldTypeText: 'Ligne simple',
    customTypeFieldTypeTextarea: 'Texte long', customTypeRemoveFieldTitle: 'Retirer ce champ',
    customTypeDefaultFieldLabel: 'Description',
    customTypeNameRequired: 'Donnez un nom à ce type de fiche.',
    customTypeFieldsRequired: 'Ajoutez au moins un champ avec un nom.',
    customTypeFieldsHint: 'Chaque champ est une information de la fiche (comme "Prénom" ou "Âge" pour un Personnage). Ajoutez-en autant que nécessaire ; le ✕ retire un champ que vous ne voulez plus.',
    customTypeDuplicateField: 'Le champ "{label}" est utilisé plusieurs fois : donnez un nom différent à chacun.',
    customTypeEditTitle: 'Modifier ce type', customTypeDeleteTitle: 'Supprimer ce type',
    customTypeEditModalTitle: 'Modifier le type de fiche',
    customTypeDeleteBlocked: 'Impossible de supprimer "{label}" : {count} fiche(s) utilisent encore ce type. Supprimez-les ou changez leur type d\'abord.',
    customTypeConfirmDelete: 'Supprimer définitivement le type "{label}" ? Cette action est irréversible.',
    wbIconInputTitle: "Icône de la fiche (change dans la sidebar et les onglets)",
    wbIconCustomPlaceholder: 'Autre…', wbIconCustomApply: 'OK',
    wbColorLabel: 'Couleur de surlignage dans les chapitres',
    wbMentionedInLabel: '📖 Mentionné dans', wbMentionedInNone: "Pas encore mentionné dans un chapitre.",
    wbReadModeTitle: 'Basculer en mode lecture (fige la fiche contre les modifications accidentelles)',
    ...
    closeTabUnsavedWarning: 'La dernière sauvegarde de "{name}" a échoué : fermer cet onglet risque de perdre les modifications non enregistrées. Fermer quand même ?',
    ...
    timerCustomLabel: 'Ou durée personnalisée (minutes)', timerCustomPlaceholder: 'ex : 45',
    ...
    statsGoalLabel: '🎯 Objectif quotidien (mots)', statsGoalPlaceholder: 'ex : 500', statsGoalSaveBtn: 'Enregistrer',
    ...
    grammarStatusBarReady: 'Grammaire ✓', grammarStatusBarReadyTitle: 'Correction grammaticale active (cliquer pour configurer)',
    grammarStatusBarStarting: 'Grammaire…', grammarStatusBarStartingTitle: 'Démarrage du serveur LanguageTool…',
    grammarStatusBarError: 'Grammaire ⚠', grammarStatusBarErrorTitle: 'Correction grammaticale activée mais indisponible (cliquer pour diagnostiquer)',
  ...
  en: {
    cancel: 'Cancel', create: 'Create', rename: 'Rename', close: 'Close', launch: 'Start', save: 'Save',
    alreadyExists: 'This name already exists', nameRequired: 'Name is required',
    renameWbMentionsWarning: 'Renaming "{oldName}" to "{newName}" will also replace this name everywhere it appears in the text of {count} chapter(s). Continue?',
    ...
    settingsSectionAppearance: 'Appearance', settingsSectionCorrection: 'Proofing',
    settingsSectionUpdates: 'Updates',
    helpMenuBtn: '❓ Help', helpMenuBtnTitle: 'Keyboard shortcuts',
    helpModalTitle: 'Keyboard shortcuts',
    shortcutSave: 'Save', shortcutUndo: 'Undo', shortcutRedo: 'Redo',
    shortcutBold: 'Bold', shortcutItalic: 'Italic', shortcutUnderline: 'Underline',
    shortcutZoom: 'Zoom the page', shortcutWbOpen: 'Open a World Building sheet',
    shortcutAlign: 'Align (left/center/right)', shortcutReplace: 'Find / Replace',
    shortcutGlobalSearch: 'Global search', shortcutSwitchTab: 'Next / previous tab',
    shortcutZoomKeys: 'Zoom in / out / reset',
    shortcutCloseTab: 'Close the active tab', shortcutMiddleClose: 'Close a tab',
    shortcutNavigate: 'Navigate without a mouse', shortcutActivate: 'Activate a focused element',
    ...
    alignLeftTitle: 'Align left', alignCenterTitle: 'Center', alignRightTitle: 'Align right',
    sizeNormalPx: '16 px (Normal)',
    ...
    customTypeNameLabel: 'Type name', customTypeNamePlaceholder: 'e.g. Faction, Creature, Artifact…',
    customTypeIconLabel: 'Icon', customTypeColorLabel: 'Default color',
    customTypeFieldsLabel: 'Sheet fields', customTypeAddFieldBtn: '+ Add a field',
    customTypeFieldLabelPlaceholder: 'Field name', customTypeFieldTypeText: 'Single line',
    customTypeFieldTypeTextarea: 'Long text', customTypeRemoveFieldTitle: 'Remove this field',
    customTypeDefaultFieldLabel: 'Description',
    customTypeNameRequired: 'Give this sheet type a name.',
    customTypeFieldsRequired: 'Add at least one field with a name.',
    customTypeFieldsHint: 'Each field is a piece of information on the sheet (like "First name" or "Age" for a Character). Add as many as you need; ✕ removes a field you no longer want.',
    customTypeDuplicateField: 'The field "{label}" is used more than once: give each one a different name.',
    customTypeEditTitle: 'Edit this type', customTypeDeleteTitle: 'Delete this type',
    customTypeEditModalTitle: 'Edit sheet type',
    customTypeDeleteBlocked: 'Cannot delete "{label}": {count} sheet(s) still use this type. Delete them or change their type first.',
    customTypeConfirmDelete: 'Permanently delete the "{label}" type? This cannot be undone.',
    wbIconInputTitle: 'Sheet icon (updates in the sidebar and tabs)',
    wbIconCustomPlaceholder: 'Other…', wbIconCustomApply: 'OK',
    wbColorLabel: 'Highlight color in chapters',
    wbMentionedInLabel: '📖 Mentioned in', wbMentionedInNone: 'Not mentioned in any chapter yet.',
    wbReadModeTitle: 'Switch to read mode (locks the sheet against accidental edits)',
    ...
    closeTabUnsavedWarning: 'The last save of "{name}" failed: closing this tab may lose unsaved changes. Close anyway?',
    ...
    timerCustomLabel: 'Or custom duration (minutes)', timerCustomPlaceholder: 'e.g. 45',
    ...
    statsGoalLabel: '🎯 Daily goal (words)', statsGoalPlaceholder: 'e.g. 500', statsGoalSaveBtn: 'Save',
    ...
    grammarStatusBarReady: 'Grammar ✓', grammarStatusBarReadyTitle: 'Grammar checking active (click to configure)',
    grammarStatusBarStarting: 'Grammar…', grammarStatusBarStartingTitle: 'Starting the LanguageTool server…',
    grammarStatusBarError: 'Grammar ⚠', grammarStatusBarErrorTitle: 'Grammar checking enabled but unavailable (click to diagnose)',
