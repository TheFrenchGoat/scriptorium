...
export function setupTimer() {
  ...
  document.getElementById('confirmTimer').onclick = () => {
    const customValue = parseInt(document.getElementById('timerCustomInput').value, 10);
    const mins = (Number.isFinite(customValue) && customValue > 0)
      ? customValue
      : parseInt(document.getElementById('timerDurationValue').value, 10);
